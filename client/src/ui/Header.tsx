    ...
    <div className="w-full bg-whiteText md:sticky md:top-0 z-50">
        ...
        <div className="hidden md:inline-flex max-w-3xl w-full relative px-4">
          ...
          {searchText ? (
            <IoClose
              ...
              className="absolute top-2.5 right-8 text-xl hover:text-red-500 cursor-pointer duration-200"
            />
          ) : (
            <IoSearchOutline className="absolute top-2.5 right-8 text-xl" />
          )}
        </div>
        {/* Menubar */}
      ...
      <div className="w-full bg-darkText text-whiteText">
        <Container className="py-2 max-w-4xl flex items-center gap-5 justify-between">
          <p className="inline-flex items-center gap-2 rounded-md border border-gray-400 hover:border-white py-1.5 px-3 font-semibold text-gray-300 hover:text-whiteText cursor-pointer">
